...
import { db, secondaryAuth } from "../../config/firebase"; // adjust if path is different
...
const AddStudentForm = ({ onSubmit, onCancel }) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const { email, password, ...studentInfo } = formData;
    ...
    try {
      // ✅ Create student account using secondaryAuth to avoid logging out the admin
      ...
      // ✅ Log creation in studentHistory
      ...
      setSuccess(
        "Student created successfully! The student can now login with the provided credentials."
      );
