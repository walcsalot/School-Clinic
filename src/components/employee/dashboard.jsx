    ...
    return (
      <div className="flex h-screen items-center justify-center bg-gray-50 px-4">
        <div className="w-full max-w-md rounded-xl bg-white p-6 text-center shadow-lg">
          ...
          <h2 className="mt-4 text-xl font-bold text-gray-800 sm:text-2xl">Employee Data Not Found</h2>
          <p className="mt-2 text-gray-600">
            We couldn't find your employee records. Please contact the administrator for assistance.
          </p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 p-4 md:p-8">
      ...
      <header className="mb-6 rounded-2xl bg-white p-4 shadow-md sm:p-6">
        <div className="flex flex-col items-start justify-between md:flex-row md:items-center">
          <div>
            <h1 className="text-2xl font-bold text-gray-800 sm:text-3xl">Employee Dashboard</h1>
          ...
          <div className="mt-4 flex items-center md:mt-0">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">ID: {employeeData.idNumber}</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <div className="mb-6 rounded-2xl bg-gradient-to-r from-blue-600 to-indigo-600 p-4 text-white shadow-lg sm:p-6">
        ...
        <p className="max-w-2xl text-sm opacity-90 sm:text-base">
          This is your personalized health dashboard. Here you can view your profile information.
        </p>
      </div>
        ...
        <div className="rounded-2xl bg-white p-4 shadow-md sm:p-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center">
              ...
              <div>
                <p className="text-xs text-gray-500 sm:text-sm">Employee ID</p>
                <p className="text-sm font-medium sm:text-base">{employeeData.idNumber}</p>
              </div>
            </div>
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm font-medium sm:text-base">{employeeData.age} years</p>
              </div>
            </div>
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm font-medium capitalize sm:text-base">{employeeData.gender}</p>
              </div>
            </div>
            ...
            <div className="flex items-center">
              ...
              <div>
                <p className="text-xs text-gray-500 sm:text-sm">Department</p>
                <p className="text-sm font-medium sm:text-base">{employeeData.department}</p>
              </div>
            </div>
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm font-medium sm:text-base">{employeeData.email}</p>
              </div>
            </div>
          </div>
        </div>
