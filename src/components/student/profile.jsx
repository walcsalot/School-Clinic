  ...
  const fetchStudentData = async () => {
    try {
      ...
      if (!querySnapshot.empty) {
        ...
        // Set visit-related data
        setTotalVisits(data.totalVisits || 0);
        setFirstVisitDate(data.firstVisitDate?.toDate() || null);

        // If firstVisitDate doesn't exist, set it to now (for existing students)
      ...
      <div className="flex h-screen items-center justify-center bg-gray-50">
        <div className="w-full max-w-md rounded-xl bg-white p-8 text-center shadow-lg">
          ...
          <p className="mt-2 text-gray-600">
            We couldn't find your student records. Please contact the administrator.
          </p>
    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-8">
      ...
      <div className="mb-8 rounded-2xl bg-white p-6 shadow-md">
        <div className="flex flex-col items-start justify-between md:flex-row md:items-center">
          <div>
            ...
            <p className="mt-1 text-gray-600">View and manage your academic information</p>
          </div>
      ...
      {editing ? (
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center rounded-md border border-gray-300 bg-gray-100 px-3 py-2">
                <span>{studentData.idNumber}</span>
              </div>
        ...
        <div className="grid grid-cols-1 gap-8">
          {/* Personal Information and Academic Information Cards */}
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="font-medium">{studentData.idNumber}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="font-medium">{studentData.age} years</p>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="pt-4">
                  ...
                  <p className="mt-1 text-sm text-gray-600">
                    For security reasons, some information cannot be changed here. Please contact the
                    administration for assistance with account-related issues.
                  </p>
                </div>
              </div>
            </div>
